...
def _set_attr(cfg_obj, key, value):
...
class Config(BaseSettings):
    ...
    def __post_init__(self):
        if self.config_file is None:
            raise NotImplementedError(f"{self.__class__.__name__} must define 'config_path'")
    ...
    def load(cls):
        ...
        instance = _load_yaml_data(BASE_CONFIG_PATH, instance)
        ...
        instance = _load_yaml_data(config_file_path, instance)
